<x-app-layout>
    ...
    <div x-data="{ detail:false }" class="grid grid-cols-3 gap-6 mx-auto mb-4 max-w-7xl">
        @foreach($transactions as $transaction)
            ...
            <!-- Main modal -->
            <div x-show="detail" class="fixed top-0 left-0 right-0 z-50 items-center justify-center w-full max-h-full overflow-x-hidden overflow-y-auto bg-black bg-opacity-50 md:inset-0">
                <div class="relative w-full max-w-2xl max-h-full p-4">
                    <!-- Modal content -->
                    <div class="relative mx-auto bg-white rounded-lg shadow dark:bg-gray-700">
                        <!-- Modal header -->
