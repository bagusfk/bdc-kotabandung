        ...
        <div class="grid max-md:grid-cols-1 lg:grid-cols-3 max-lg:grid-cols-2 gap-4">
            ...
            <div class="my-4 w-full">
                <a href="{{route('company_profile')}}"
                    class="w-full inline-block pl-[3.5rem] hover:underline max-md:py-2">Company</a>
            ...
            <div class="my-4">
                <div class="flex items-center h-10 lg:pl-[5rem]">
                    ...
                    <a href="https://www.instagram.com/bdc.bandungjuara/" target="_blank"
                        class="align-middle ml-4 hover:underline">@bdjbandungjuara</a>
                </div>
                <div class="flex items-center h-10 my-4 lg:pl-[5rem]">
                    ...
                    <a href="whatsapp://send?phone=6281222541485" target="_blank"
                        class="align-middle ml-4 hover:underline">0812-2254-1485</a>
                </div>
            </div>
        </div>
    </section>
