<x-guest-layout>
    <form x-data="{ show: false }" method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="no_wa" class="block w-full mt-1" type="text" name="no_wa" :value="old('no_wa')" required autocomplete="username" />
        ...
        <div class="flex items-center justify-end mt-4">
            <a class="items-center px-4 py-2 text-xs font-semibold tracking-widest text-white uppercase transition duration-150 ease-in-out bg-gray-800 border border-transparent rounded-md dark:bg-gray-200 dark:text-gray-800 hover:bg-gray-700 dark:hover:bg-white focus:bg-gray-700 dark:focus:bg-white active:bg-gray-900 dark:active:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800" href="{{ route('login') }}">
                {{ __('Batal') }}
            </a>
